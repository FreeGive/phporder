...
<style type="text/css">
.wforder{max-width:<?php echo $t21['fw']; ?>;}
.wftitle{background:<?php echo $t21['titbg']; ?>;}
</style>
</head>
<body>
<div class="wforder">
	<form id="wfform" name="wfform" method="post" class="wfform layui-form" target="_top">
		...
		<div class="wftitle"><?php if($t[4]){echo '<img src="../'.$t[4].'">';}else{echo $t[3];}?></div>		
		<!---------- 订购产品 ---------->
		<?php if(!empty($p3)){?>
        <div class="wfwrap">			
            <div class="wfwrapbox">
				...
				<div class="wfform-box">
					<div class="wfproimg"><img src="../<?php echo $p[2]; ?>"><p><?php echo $p[1]; ?><br><span style="font-size:12px;font-weight:100;color:#999;">货到付款并包邮</span></p></div>
				</div>
				<?php }?>				
				<!---------- 产品套餐 ---------->
				<div class="wfform-box">
		...
		<div class="wfwrap">			
			...
			<!---------- 表单选项 ---------->
			<?php
			foreach($t8 as $key=>$val){
				if($key!='wfnums'){echo $wfformopt[$key];}
			}
			?>	
			<!---------- 表单选项 ---------->
			<!---------- 付款方式 ---------->
	...
	<div class="wftitle"><?php if($t[15]){echo '<img src="../'.$t[15].'">';}else{echo $t[14];}?></div>
	<div class="wfwrap">
		<div class="wfwrapbox">
			<div class="wffahuo">
				<ul>
