<?php
require WFPAY.'/weixin/lib/WxPay.Exception.php';
require WFPAY.'/weixin/lib/WxPay.Data.php';
...
class WxPayApi{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6){
		...
		$inputObj->SetAppid($wfpay['wx_appid']);//公众账号ID
		$inputObj->SetMch_id($wfpay['wx_mchid']);//商户号
		$inputObj->SetSpbill_create_ip(WFdblink::wfuserip());//终端ip	  
	...
	public static function report($inputObj, $timeOut = 1){
		...
		$inputObj->SetAppid($wfpay['wx_appid']);//公众账号ID
		$inputObj->SetMch_id($wfpay['wx_mchid']);//商户号
		$inputObj->SetUser_ip(WFdblink::wfuserip());//终端ip
